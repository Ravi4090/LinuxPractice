...
# sudo yum install java -y Old command that i have used poreviously

sudo dnf install java-17-amazon-corretto -y # command specified by the Jenkins Documentation
